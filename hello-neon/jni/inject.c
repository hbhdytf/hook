...
int main(int argc, char** argv) {
	pid_t target_pid;
	//target_pid = find_pid_of("in.wptraffcianalyzer.filereadwritedemo");
	//target_pid = find_pid_of("com.qq.reader");
	//target_pid = find_pid_of("com.chaozh.iReaderFree");
	//target_pid = find_pid_of("cn.wps.moffice_eng");
	//target_pid = find_pid_of("com.mobisystems.office:word");
	target_pid = find_pid_of("com.baidu.browser.apps");
	LOGD("[+] The pid of com.qq.reader: %d\n", target_pid);
